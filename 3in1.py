...
class Main(Frame):
    ...
    def startUI(self):
        btn = Button(root, text="1", font=("Times New Roman", 15),
        ...
        btn.place(x=10, y=100, width=50, height=50)
        btn2.place(x=155, y=100, width=50, height=50)
        btn3.place(x=300, y=100, width=50, height=50)
        btn4.place(x=445, y=100, width=50, height=50)
        btn5.place(x=590, y=100, width=50, height=50)
